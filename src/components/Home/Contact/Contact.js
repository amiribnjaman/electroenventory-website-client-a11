    ...
    return (
        <div className='py-24 w-10/12 mx-auto md:flex'>
            <div className='text-center md:text-left md:w-2/5 mr-8 flex flex-col justify-center'>
                ...
                <div className='mt-4'>
                <button type="button" class="text-white bg-[#0070DC] hover:bg-[#097be5] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 mr-2 mb-2">Contact Now <FontAwesomeIcon className='ml-2' icon={faEnvelope}/></button>
                </div>
