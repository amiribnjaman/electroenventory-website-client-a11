        ...
        <>
            {
                ...
                spinner ? <div className='text-center pt-10 pb-6'>
                    <svg role="status" class="inline w-10 h-10 mr-2 my-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </div> : <div className='flex w-5/6 mx-auto shadow my-10 px-4 py-6'>
                    <div className='w-1/4'>
                    ...
                    <div className='p-4 w-2/4'>
                        <ol class="relative border-l border-gray-200">
                            <li class="mb-10 ml-5">
                                ...
                                <p class="mb-4 pr-14 text-sm font-normal text-gray-700">{description}</p>
                                <div className='mb-5'>
                    ...
                    <div>
                        <form
                            ...
                            className='relative border-l mt-4 border-gray-200'>
                            <div className='ml-5'>
                                <div class="mb-6">
                                    <h4 className='text-lg font-semibold mb-2'>Restock</h4>
                                    <input
                                        onChange={handleRestockChange}
                                        type="number" id="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required="" />
                                </div>
                                <button
                                    type="submit" class="text-white hover:bg-[#0070DC] bg-[#037ef0] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                            </div>
                        </form>
            ...
            {item !== {} ? <div className='w-1/4 mx-auto text-center mt-10 mb-10'>
                <button
