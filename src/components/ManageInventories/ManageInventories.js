            ...
            <div className='w-10/12 mx-auto my-14'>
                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {
                                items.map(item => <tr className="border-b  dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
                                    <th scope="row" className="px-2 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        {++slNumber}
                                    </th>
                                    <th scope="row" className="px-6 pr-6 pl-3 py-4 font-medium text-gray-900 whitespace-nowrap">
                                        {item.name}
                                    </th>
                                    ...
                                    <td className="px-6 py-4 text-left">
                                        ...
                                        <button
                                            ...
                                            className="font-medium text-[18px] text-red-500 lg:pl-3 pl-1 inline-block">
                ...
                {spinner ? <div className='text-center'>
                    <svg role="status" className="inline mt-12 w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
