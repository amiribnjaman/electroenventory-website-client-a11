                    ...
                    <footer>
                        <div className="py-10 px-4 bg-[#F7F8F9]">
                            <div className='md:flex md:items-center md:justify-between w-10/12 mx-auto'>
                                <span className="text-sm text-slate-700 sm:text-center">&copy; {currentYear} <Link to=""> electro<span className='text-[#fc9c20]'>Inventory</span></Link>. All Rights Reserved.
                                </span>
