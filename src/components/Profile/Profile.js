    ...
    return (
        <div className='w-10/12 md:flex mx-auto mt-20 mb-10'>
            ...
            <div className='md:w-2/6 relative'>
                <aside className="w-full md:w-72 relative" aria-label="Sidebar">
                    <div className='absolute -top-10 left-24'>
                        {user?.photoURL ? <div className="flex flex-col items-center ">
                            <img className="w-16 h-16 border-2 border-gray-200 p-1 rounded-full" src={user?.photoURL} alt="" />
                            <div className="font-medium text-center mt-2">
                                <div>{user?.displayName.split(' ')[0] || user?.email.split('@')[0]}</div>
                                <p className="text-sm text-gray-500 ">General User</p>
                            </div>
                        </div> : <div className='text-center'>
                            <div className="relative w-16 h-16 overflow-hidden bg-gray-100 rounded-full">
                                <svg className="absolute w-18 h-18 mx-auto text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                            </div>
                    ...
                    <div className="md:overflow-y-auto pb-4 pt-24 px-3 bg-gray-50 rounded dark:bg-gray-800">
            ...
            <div className='mt-6 md:mt-0 md:w-4/6' id='dashboard'>
                <div className="p-4 w-full min-h-full text-left bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">

                    <ol className="relative border-l border-gray-200 dark:border-gray-700">
                        <li className="mb-10 ml-4">
                            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white text-left"></div>
                    ...
                    <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 mt-6">Edit Profile</button>
                </div>
