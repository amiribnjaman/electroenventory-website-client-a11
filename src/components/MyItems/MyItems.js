...
const MyItems = () => {
    ...
    return (
        <div className='w-10/12 mt-10 mb-10 mx-auto my-14'>
            ...
            {/* My items data */}
            {
                myItems.length > 0 ? myItems.map(item => <div class="p-4 mb-2 w-full text-center bg-white rounded-lg border shadow-md sm:p-8">
                    ...
                    <div className='text-center'>
                        ...
                        <button
                            ...
                            type="button" class=" text-center text-white ml-4 bg-[#0070DC] hover:bg-[#097be5] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 mt-4 mb-2">Add New Item</button>
                    </div>
                </>
            }
